...
we use Reduce to aggregrate the values from previous step, using a Binary Operator functional interface called daccumulator.

steps are visualied as follows
